...
export const translations = {
  ...
  zh: {
    ...
    avatarQuotaReached: '已达创建上限，邀请更多咨询师并通过验证可增加名额',
    avatarQuotaInfo: 'Avatar 额度',
    inviteTab: '邀请',
    inviteProTitle: '邀请咨询师',
    inviteProDesc: '1. 邀请心理咨询师加入 Hamo，每位通过验证的邀请可增加 1 个 Avatar 创建名额。\n2. 总共邀请两位以上验证的心理咨询师，即刻开通「来访者预约一对一咨询」功能。',
    generateProInviteCode: '生成邀请码',
    needVerifyBeforeInvite: '您需要通过咨询师验证后，才可以邀请。',
    invitedPros: '已邀请的咨询师',
    noInvitesYet: '暂无邀请记录',
    ...
    serviceIncome: '服务收入',
    inviteIncome: '邀请收入',
    serviceIncomeNote: '每日根据虚拟咨询师的服务Token比例自动分配计算入账。',

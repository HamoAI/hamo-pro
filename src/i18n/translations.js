...
export const translations = {
  en: {
    ...
    sessionExpiredMessage: 'Your session has expired for security reasons. Please sign in again to continue — your unsaved changes will be lost.',
  ...
  zh: {
    ...
    sessionExpiredMessage: '出于安全原因，您的登录已过期。请重新登录以继续 —— 未保存的修改将会丢失。',

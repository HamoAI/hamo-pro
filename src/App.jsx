                            ...
                            {clients.map(c => {
                                ...
                                return (
                                    <div key={c.id} className="bg-white rounded-xl shadow-md p-6">
                                        ...
                                        <p className="text-sm"><span className="font-medium">Avatar:</span> {avatar?.name}</p>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    {clients.map(c => (
                                        <div key={c.id} className="bg-white rounded-xl shadow-md p-6">
                                            ...
                                            <button onClick={() => setSelectedClient(c)} className="mt-4 w-full bg-blue-50 text-blue-600 px-4 py-2 rounded-lg flex items-center justify-center space-x-2"><Eye className="w-4 h-4" /><span className="text-sm">View Chats</span></button>
                                        </div>
                                    ))}
                                </div>
                                {selectedClient && (
                                    <div className="bg-white rounded-xl shadow-md p-6">
                                        <div className="flex justify-between mb-6">
                                            ...
                                            <button onClick={() => setSelectedClient(null)} className="text-gray-500">Close</button>
                                        </div>
